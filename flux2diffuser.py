...
model_path = "/SDModel/unet/v04_adapter.sft"
...
transformer.save_pretrained("/Disk1/SimpleTuner/ckpt/flux-adapterV04", safe_serialization=True, use_safetensors=True)
